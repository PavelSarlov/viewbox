defmodule Viewbox.Accounts do
  ...
  alias Viewbox.Accounts.{User, UserToken, UserNotifier}
  ...
  """
  def get_user_by_session_token(token, preloads \\ [])

  def get_user_by_session_token(nil, _preloads) do
    nil
  end
