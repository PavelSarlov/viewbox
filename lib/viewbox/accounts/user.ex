defmodule Viewbox.Accounts.User do
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Viewbox.Repo)
  ...
  defp maybe_validate_unique_username(changeset, opts) do
    if Keyword.get(opts, :validate_username, true) do
      changeset
      |> unsafe_validate_unique(:username, Viewbox.Repo)
  ...
  """
  def valid_password?(%Viewbox.Accounts.User{hashed_password: hashed_password}, password)
